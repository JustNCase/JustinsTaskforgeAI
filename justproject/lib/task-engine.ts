...
export const unitTestExamples = {
  // Example 1: High priority task (urgent, high impact, low effort)
  highPriorityTask: {
    task: {
    ...
    expectedScore: 10 * 0.4 + 10 * 0.5 - 2 * 0.1, // 9.8
    expectedPriority: PriorityLevel.HIGH,
  },

  // Example 2: Low priority task (low urgency, low impact, high effort)
  lowPriorityTask: {
    task: {
    ...
    expectedScore: 2 * 0.4 + 3 * 0.5 - 9 * 0.1, // 1.5
    expectedPriority: PriorityLevel.LOW,
  },

  // Example 3: Medium priority task (balanced)
  mediumPriorityTask: {
    task: {
    ...
    expectedScore: 6 * 0.4 + 7 * 0.5 - 5 * 0.1, // 6.1
    expectedPriority: PriorityLevel.MEDIUM,
  },

  // Example 4: Edge case - minimum values
  minValuesTask: {
    task: {
      title: 'Simple task',
    ...
    expectedScore: 1 * 0.4 + 1 * 0.5 - 1 * 0.1, // 0.8
    expectedPriority: PriorityLevel.LOW,
  },

  // Example 5: Edge case - maximum values
  maxValuesTask: {
    task: {
    ...
    expectedScore: 10 * 0.4 + 10 * 0.5 - 1 * 0.1, // 13.9
    expectedPriority: PriorityLevel.HIGH,
  },
};

// Mock AI task breakdown templates
