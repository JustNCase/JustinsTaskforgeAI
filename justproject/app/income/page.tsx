...
export default function IncomePage() {
  ...
  // const totalPriorityScore = tasks.reduce((sum, task) => sum + (task.priority === PriorityLevel.HIGH ? 100 : task.priority === PriorityLevel.MEDIUM ? 50 : 25), 0); // Not used but kept for potential future use
